...
class LieuNaissancesForm extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        ...
        $builder->get('cercle')->addEventListener(
            FormEvents::POST_SUBMIT,
            function (FormEvent $event) {
                $form = $event->getForm();
                $data = $form->getData();
                $this->addCommuneField($form->getParent(), $data);
            }
        );
        $builder->addEventListener(
            ...
            function (FormEvent $event) {
                ...
                // Récupérer le cercle via la commune si disponible
    ...
    public function addCommuneField(FormInterface $form, ?Cercles $cercles)
    {
