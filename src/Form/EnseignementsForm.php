...
class EnseignementsForm extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ->add('designation', TextType::class, [
                'label' => 'Enseignement',
                'attr' => [
                    'placeholder' => 'Ex: Enseignement classique',
                    'class' => 'w-full px-4 py-2 border rounded-lg focus:ring-blue-500 focus:border-blue-500 tomselect-enseignement',
                    'minlength' => 2,
                    'maxlength' => 255,
                ],
