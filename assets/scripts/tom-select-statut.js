...
document.addEventListener('DOMContentLoaded', () => {
    const selectElements = document.querySelectorAll('.tomselect-statut');
    ...
    // Définir la regex pour la validation des statuts
    ...
    selectElements.forEach(selectElement => {
        ...
        new TomSelect(selectElement, {
            ...
            load: function (query, callback) {
                ...
                fetch(`/statuts/search?term=${encodeURIComponent(query)}`, {
            ...
            create: function (input, callback) {
                ...
                fetch(`/statuts/create/${encodeURIComponent(cleanedInput)}`, {
                    method: 'POST',
                    headers: {
