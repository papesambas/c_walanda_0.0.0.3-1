...
final class Telephones1ControllerTest extends WebTestCase
{
    ...
    public function testNew(): void
    {
        ...
        $this->client->submitForm('Save', [
            ...
            'telephones1[createdAt]' => 'Testing',
            'telephones1[updatedAt]' => 'Testing',
            'telephones1[slug]' => 'Testing',
            'telephones1[peres]' => 'Testing',
            'telephones1[meres]' => 'Testing',
            'telephones1[createdBy]' => 'Testing',
            'telephones1[updatedBy]' => 'Testing',
        ]);
    ...
    public function testEdit(): void
    {
        ...
        $this->client->submitForm('Update', [
            ...
            'telephones1[createdAt]' => 'Something New',
            'telephones1[updatedAt]' => 'Something New',
            'telephones1[slug]' => 'Something New',
            'telephones1[peres]' => 'Something New',
            'telephones1[meres]' => 'Something New',
            'telephones1[createdBy]' => 'Something New',
            'telephones1[updatedBy]' => 'Something New',
        ]);
