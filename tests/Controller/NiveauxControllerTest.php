...
final class NiveauxControllerTest extends WebTestCase
{
    private KernelBrowser $client;
    private EntityManagerInterface $manager;
    private EntityRepository $niveauRepository;
    ...
    protected function setUp(): void
    {
        ...
        $this->niveauRepository = $this->manager->getRepository(Niveaux::class);

        foreach ($this->niveauRepository->findAll() as $object) {
    ...
    public function testNew(): void
    {
        ...
        self::assertSame(1, $this->niveauRepository->count([]));
    }
    ...
    public function testEdit(): void
    {
        ...
        $fixture = $this->niveauRepository->findAll();
    ...
    public function testRemove(): void
    {
        ...
        self::assertResponseRedirects('/niveaux/');
        self::assertSame(0, $this->niveauRepository->count([]));
    }
}
