...
final class Telephones2ControllerTest extends WebTestCase
{
    ...
    public function testNew(): void
    {
        ...
        $this->client->submitForm('Save', [
            ...
            'telephones2[createdAt]' => 'Testing',
            'telephones2[updatedAt]' => 'Testing',
            'telephones2[slug]' => 'Testing',
            'telephones2[peres]' => 'Testing',
            'telephones2[meres]' => 'Testing',
            'telephones2[createdBy]' => 'Testing',
            'telephones2[updatedBy]' => 'Testing',
        ]);
    ...
    public function testEdit(): void
    {
        ...
        $this->client->submitForm('Update', [
            ...
            'telephones2[createdAt]' => 'Something New',
            'telephones2[updatedAt]' => 'Something New',
            'telephones2[slug]' => 'Something New',
            'telephones2[peres]' => 'Something New',
            'telephones2[meres]' => 'Something New',
            'telephones2[createdBy]' => 'Something New',
            'telephones2[updatedBy]' => 'Something New',
        ]);
